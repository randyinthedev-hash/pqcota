...
| [Demo design](../demo/design.en.md) | how the demo is put together and why: the build machine, the running containers, what each step does, and why an empty provider file is used. How to run it is in [demo/README](../demo/README.en.md) |
